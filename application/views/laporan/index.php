<div class="row">
    ...
    ?>
																<button type="button"class="btn btn-info btn-sm tambahButton" data-toggle="modal" data-target="#formModal" value="<?php echo $pengajuan['id_pengajuan'] ?>">Buat Laporan</button>
															<?php
} else {
        ?>
								...
								<div class="table-responsive">
					              ...
					              <?php foreach ($laporan as $laporan): ?>
					                <tr>
					                  ...
					                  <td>
															<button type="button"class="btn btn-info btn-sm editButton" data-toggle="modal" data-target="#formModal" value="<?php echo $laporan['id_laporan'] ?>"><span class="fa fa-edit"></span>
															</button><button type="button"class="btn btn-danger btn-sm deleteButton" data-toggle="modal" data-target="#myModal" value="<?php echo $laporan['id_laporan'] ?>"><span class="fa fa-trash-o"></span></button>
					                  </td>
					                </tr>
					              <?php endforeach; ?>
					            </tbody>
