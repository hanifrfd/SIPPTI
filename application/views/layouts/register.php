    ...
    <div class="login-container lightmode">
        ...
        <div class="login-box animated fadeInDown">
            ...
            <div class="login-body">
                <div class="login-title"><strong>Daftar</strong></div>
                ...
                <div class="form-group">
                    <div class="col-md-6">
											<!-- <button type="submit" class="btn btn-default btn-block">Kembali</button> -->
											<a href="<?php echo base_url();?>C_user" class="btn btn-success btn-block">Kembali</a>
                    </div>
                    <div class="col-md-6">
