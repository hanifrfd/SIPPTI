<div class="row">
	...
	<div class="col-md-10 col-md-push-1">
		<div class="panel panel-default">
			<a href="#add" class="btn btn-info btn-md tambahButton push-up-10 push-down-10" style="margin-left:3%;"
			 data-toggle="modal" data-target="#formModal">Tambah Pengajuan</a>
				...
				<div class="table-responsive">
					...
					<table id="tableDataPengajuan" class="table table-bordered  table-actions" style="display:none;">
						...
						<tbody>
							...
							<tr>
								<td>
									<?php echo $pengajuan['id_pengajuan'] ?>
								</td>
								<td>
									<?php echo $pengajuan['UnitKerja'] ?>
								</td>
								<td>
									<?php echo $pengajuan['Permasalahan'] ?>
								</td>
								<td>
									<?php echo $pengajuan['Waktu'] ?>
								</td>

								<?php if ($pengajuan['id_status']==1): ?>
								<td>
									<h5><span class="label label-success">
											<?php echo $pengajuan['Status'] ?></span></h5>
								</td>
								<?php endif; ?>
...
<?php elseif ($this->session->flashdata('msg-update-berhasil')) :
                                                                ?>
<script type="text/javascript">
	$(document).ready(function () {
